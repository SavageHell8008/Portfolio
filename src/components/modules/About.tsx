...
export default function About() {
    ...
    return (
        <div ref={containerRef} className="opacity-0 translate-y-4 transition-all duration-500 h-full w-full overflow-y-auto scroll-smooth p-6">
            <ModuleCloseButton />

            <div className="flex gap-6">

                {/* Profile Image & Scan */}
                <div className="w-1/3 min-h-[500px] relative group">
                    <div className="h-[500px] bg-cyber-primary/10 border border-cyber-primary/30 rounded-lg overflow-hidden relative">
                        {!imgError ? (
                            <img
                                src="/me.jpg"
                                alt="Abhishek Soni"
